...
#define MAXBUF 1024
#define BOMB_USER "eslab_shell"
#define BOMB_HOST "embedded.cnu.ac.kr"
...
int main(int argc, char **argv) 
{
	...
	if (strcmp(buf, PROMPT)) {
	    fprintf(stderr,"You try to copy. so you are invaild and you will get F grade\n");
		send_msg(0);
